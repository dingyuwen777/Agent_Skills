...
3. 然后读取本仓库 [`.agents/skills/ROUTER.md`](.agents/skills/ROUTER.md)；
...
2. 读取 [`.agents/skills/ROUTER.md`](.agents/skills/ROUTER.md)；
...
如果 [`.agents/MAINTENANCE.md`](.agents/MAINTENANCE.md)、Router、必需 Skill 或命中的 Reference 无法读取，必须明确指出缺失事实，并停止依赖该规则的动作；不得用旧记忆、摘要或推测声称“已经按 Skill 执行”。
...
3. 在任何写入前重新读取 Agent_Skills **当前目标分支**的本 `AGENTS.md`、[`.agents/MAINTENANCE.md`](.agents/MAINTENANCE.md) 和 [`.agents/skills/ROUTER.md`](.agents/skills/ROUTER.md)，再由 Coding 进入规则内容守恒与受影响 Skill；
