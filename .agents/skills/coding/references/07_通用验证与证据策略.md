<!-- agent-routing:v1
{"协议":"Agent Skills Reference路由/v1","标识":"coding.reference.07","触发":{"任一":[{"包含":{"维度":"风险","取值":["L2","L3"]}},{"包含":{"维度":"治理","取值":["CI 变更","要求完成门禁"]}},{"包含":{"维度":"能力","取值":["测试"]}},{"包含":{"维度":"执行模式","取值":["验证"]}}]},"依赖":["coding.reference.02"]}
-->
