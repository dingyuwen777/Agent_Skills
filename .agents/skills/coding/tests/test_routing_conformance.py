...
CASES = [
    ...
    _case("Agent Outcome Eval", {"执行模式": ["验证"], "风险": ["L1"], "意图": ["Agent效果评测"]}, ["coding.reference.02", "coding.reference.32"], ["coding"], "L1", forbidden_references=["coding.reference.04", "coding.reference.10", "coding.reference.11", "coding.reference.19"]),
