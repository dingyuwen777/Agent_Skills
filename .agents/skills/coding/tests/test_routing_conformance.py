...
class RoutingConformanceTest(unittest.TestCase):
    ...
    def test_benchmark_covers_mandatory_task_families(self) -> None:
        ...
        mandatory = {
            "Ad-hoc snippet", "Greenfield", "Fact Recovery", "L1 mechanical", "L2 Feature",
            "Light L2 targeted validation", "Gated L2", "L3 public API", "Bug", "Failure / Incident",
            "Refactor", "Performance", "Schema Migration", "Frontend", "Figma review-only",
            "Figma review-and-fix", "Figma baseline-ready", "Figma → Code", "Docs not_applicable",
            "Docs targeted", "Docs full", "Review-only", "Review-and-test", "Review-and-fix",
            "Multi-Agent", "Multiple Active Changes", "Dependency Upgrade", "CI Workflow Change",
