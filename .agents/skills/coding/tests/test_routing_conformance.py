...
CASES = [
    ...
    _case("Figma → Code", {"执行模式": ["实现"], "项目形态": ["前端Web"], "阶段": ["功能开发"], "风险": ["L2"], "范围": ["前端"], "意图": ["设计转代码"], "能力": ["Figma"]}, LIGHT_L2_CORE + ["coding.reference.05", "coding.reference.08", "coding.reference.17", "figma.reference.00", "figma.reference.01", "figma.reference.02", "figma.reference.03", "figma.reference.04", "figma.reference.05", "figma.reference.06", "figma.reference.07"], ["coding", "figma"], "L2", forbidden_references=["coding.reference.19", "coding.reference.21"]),
    ...
    _case("复杂多条件叠加", {"执行模式": ["实现", "审查", "验证", "Git"], "项目形态": ["前端Web", "全栈应用"], "阶段": ["功能开发", "交付"], "风险": ["L3"], "工具链": ["TypeScript"], "范围": ["前端", "API", "公共契约", "Runtime Bundle"], "意图": ["设计转代码", "Docs full", "Review-and-fix", "Git 交付"], "治理": ["多个活动变更", "要求完成门禁"], "能力": ["Figma", "Git", "测试", "多 Agent"], "授权": ["允许修改项目"]}, RUNTIME_CORE + ["coding.reference.05", "coding.reference.08", "coding.reference.09", "coding.reference.11", "coding.reference.15", "coding.reference.17", "docs.reference.01", "docs.reference.02", "docs.reference.03", "figma.reference.00", "figma.reference.01", "figma.reference.02", "figma.reference.03", "figma.reference.04", "figma.reference.05", "figma.reference.06", "figma.reference.07", "review.reference.01", "review.reference.02", "review.reference.03"], ["coding", "docs", "figma", "review"], "L3"),
]
