...
CASES = [
    ...
    _case("Figma review-and-fix", {"执行模式": ["实现"], "风险": ["L2"], "意图": ["Figma review-and-fix"], "能力": ["Figma"]}, LIGHT_L2_CORE + ["figma.reference.00", "figma.reference.01", "figma.reference.06", "figma.reference.07"], ["coding", "figma"], "L2", forbidden_references=["coding.reference.19", "coding.reference.21"]),
    _case("Figma baseline-ready", {"执行模式": ["方案"], "风险": ["L2"], "意图": ["Figma baseline-ready"], "能力": ["Figma"]}, LIGHT_L2_CORE + ["figma.reference.00", "figma.reference.01", "figma.reference.02", "figma.reference.03", "figma.reference.04", "figma.reference.05", "figma.reference.07"], ["coding", "figma"], "L2", forbidden_references=["coding.reference.19", "coding.reference.21"]),
    ...
    _case("Backend Python 不推断 FastAPI/PostgreSQL", {"执行模式": ["只读分析"], "项目形态": ["后端服务"], "风险": ["L1"], "工具链": ["Python"]}, ["coding.reference.02", "coding.reference.03", "coding.reference.08"], ["coding"], "L1", forbidden_references=["coding.reference.17", "coding.reference.19", "coding.reference.21", "figma.reference.00"]),
    _case("Design-only Figma 不伪造 API/代码事实", {"风险": ["L2"], "意图": ["Figma baseline-ready"], "能力": ["Figma"], "授权": ["允许只读"]}, ["figma.reference.00", "figma.reference.01", "figma.reference.02", "figma.reference.03", "figma.reference.04", "figma.reference.05", "figma.reference.07"], ["figma"], "L2", forbidden_references=["coding.reference.06", "coding.reference.17", "coding.reference.19", "coding.reference.21"]),
    _case("Unknown project shape on Runtime v3", {"执行模式": ["方案"], "风险": ["L2"], "范围": ["Runtime", "MCP"], "意图": ["Runtime Bundle"]}, RUNTIME_CORE + RUNTIME_V3_UNKNOWN_PROJECT_SHAPE, ["coding"], "L3", unknown=["项目形态"], forbidden_references=["coding.reference.21", "figma.reference.00"]),
    _case("Unknown facts", {"执行模式": ["实现"], "风险": ["L2"], "治理": ["要求完成门禁"]}, GATED_L2_CORE, ["coding"], "L2", unknown=["项目形态", "工具链"], forbidden_references=["coding.reference.21"]),
    _case("复杂多条件叠加", {"执行模式": ["实现", "审查", "验证", "Git"], "项目形态": ["全栈应用"], "阶段": ["功能开发", "交付"], "风险": ["L3"], "工具链": ["已确认"], "范围": ["前端", "API", "持久化", "公共契约"], "意图": ["设计转代码", "Docs targeted", "Review-and-test", "PR Ready"], "治理": ["要求完成门禁", "CI 变更"], "能力": ["Figma", "Git", "测试"], "授权": ["允许修改项目", "允许测试", "允许 Git"]}, ["coding.reference.02", "coding.reference.03", "coding.reference.04", "coding.reference.05", "coding.reference.06", "coding.reference.07", "coding.reference.08", "coding.reference.10", "coding.reference.11", "coding.reference.15", "coding.reference.17", "docs.reference.01", "figma.reference.00", "review.reference.01"], ["coding", "docs", "figma", "review"], "L3", forbidden_references=["coding.reference.21"]),
]


class RoutingConformanceTest(unittest.TestCase):
    """验证正式路由对代表性任务不会欠披露、不会退化到全库，并保持 Source/Runtime 同值。"""
