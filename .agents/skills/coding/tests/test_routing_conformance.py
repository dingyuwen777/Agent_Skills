...
CASES = [
    ...
    _case("Review-only", {"执行模式": ["审查"], "风险": ["L2"], "意图": ["Review-only"]}, REVIEW_CORE + ["review.reference.02", "review.reference.04"], ["coding", "review"], "L2", forbidden_references=["docs.reference.01", "coding.reference.21"]),
